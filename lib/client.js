window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		const CREATE_FILE_ACTION = "create-file";
		const MKDIR_ACTION = "mkdir";
...
Please report this to https://github.com/markedjs/marked.`, e) {
		...
		//#endregion
		//#region src/client/preview/csv-parse.ts
		/**
		...
		*/
		...
		//#endregion
		//#region src/client/preview/csv.tsx
		const CSV_MAX_ROWS = 1e3;
		const CSV_MAX_COLS = 256;
		const cache = /* @__PURE__ */ new Map();
		/** Build (and memoize) the built-in CSV preview for a given reader. */
		function makeCsvPreview(readRawFile) {
			const hit = cache.get(readRawFile);
			if (hit !== void 0) return hit;
			const Component = (props) => /* @__PURE__ */ (0, react_jsx_runtime.jsx)(CsvPreviewInner, {
				...props,
				readRawFile
			});
		...
		function CsvPreviewInner(props) {
			const { preview } = props;
			if (preview.kind === "text") return /* @__PURE__ */ (0, react_jsx_runtime.jsx)(CsvTable, {
				content: preview.content,
				t: props.t
			});
			if (preview.kind === "text-large" && props.readRawFile !== void 0) {
				const Paged = makeTextPagedPreview(props.readRawFile);
				return /* @__PURE__ */ (0, react_jsx_runtime.jsx)(Paged, { ...props });
			}
			return /* @__PURE__ */ (0, react_jsx_runtime.jsx)(StatusPreview, { ...props });
		}
		function CsvTable({ content, t }) {
			...
			if (rows.length === 0) return /* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
				className: "dsh-fe-preview-empty",
				"data-fe-csv-empty": true,
				children: t("emptyFile")
			});
			const header = rows[0];
			...
			return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
				className: "dsh-fe-csv",
				"data-fe-csv": true,
				children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
					className: "dsh-fe-csv-scroll",
					children: /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("table", {
						className: "dsh-fe-table",
						children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("thead", { children: /* @__PURE__ */ (0, react_jsx_runtime.jsx)("tr", { children: pad(header).map((cell, col) => /* @__PURE__ */ (0, react_jsx_runtime.jsx)("th", {
							scope: "col",
							children: cell
						}, col)) }) }), /* @__PURE__ */ (0, react_jsx_runtime.jsx)("tbody", { children: rowsShown.map((row, rowIndex) => /* @__PURE__ */ (0, react_jsx_runtime.jsx)("tr", { children: pad(row).map((cell, col) => /* @__PURE__ */ (0, react_jsx_runtime.jsx)("td", { children: cell }, col)) }, rowIndex)) })]
					})
				}), (rowsTruncated || colsTruncated) && /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
					className: "dsh-fe-csv-truncated",
					"data-fe-csv-truncated": true,
					children: [rowsTruncated && /* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", { children: t("csvTruncated", { rows: CSV_MAX_ROWS }) }), colsTruncated && /* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", { children: t("csvTruncatedCols", { cols: CSV_MAX_COLS }) })]
				})]
			});
		}
		//#endregion
		...
		*/
		function resolvePreviewFor(preview, ext, readRawFile) {
			if (preview.kind === "image") return previewKeyOf(ext) === "binary" ? ImagePreview : resolvePreview(ext);
		...
		function IconPlus(props) {
			...
			return /* @__PURE__ */ (0, react_jsx_runtime.jsx)("svg", {
				...
				xmlns: "http://www.w3.org/2000/svg",
				children: /* @__PURE__ */ (0, react_jsx_runtime.jsx)("path", {
					d: "M7.5 2.5h1v5h5v1h-5v5h-1v-5h-5v-1h5v-5Z",
					fill: "currentColor"
				})
			});
		}
		/** ic_ds_browse_outline_16 — inlined from `IconBrowseOutline16`. */
		function IconBrowse(props) {
			const { size = 16, className, style } = props;
			return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("svg", {
				width: size,
				height: size,
		...
		function IconMove(props) {
			...
			return /* @__PURE__ */ (0, react_jsx_runtime.jsx)("svg", {
				...
				xmlns: "http://www.w3.org/2000/svg",
				children: /* @__PURE__ */ (0, react_jsx_runtime.jsx)("path", {
					d: "M2 7H10.5V4.6L14 8L10.5 11.4V9H2Z",
					fill: "currentColor"
				})
			});
		}
		...
		//#endregion
		//#region src/client/file-action.tsx
		const actions = [];
		...
		function registerBuiltinFileActions() {
			...
			registerFileAction({
				id: "open",
				label: (t) => t("open"),
				icon: /* @__PURE__ */ (0, react_jsx_runtime.jsx)(IconBrowse, {}),
				appliesTo: "file",
				onSelect: (entry, h) => {
			...
			registerFileAction({
				...
				icon: /* @__PURE__ */ (0, react_jsx_runtime.jsx)(IconListPen, {}),
				appliesTo: "file",
				onSelect: (entry, h) => {
			...
			registerFileAction({
				...
				icon: /* @__PURE__ */ (0, react_jsx_runtime.jsx)(IconCode, {}),
				appliesTo: "file",
				onSelect: (entry, h) => {
			...
			registerFileAction({
				...
				icon: /* @__PURE__ */ (0, react_jsx_runtime.jsx)(IconCopy, {}),
				appliesTo: "both",
				onSelect: (entry, h) => {
			...
			registerFileAction({
				id: "rename",
				label: (t) => t("rename"),
				icon: /* @__PURE__ */ (0, react_jsx_runtime.jsx)(IconEdit, {}),
				appliesTo: "both",
				onSelect: (entry, h) => {
					h.promptRename(entry);
				}
			});
			registerFileAction({
				id: "move",
				label: (t) => t("moveTo"),
				icon: /* @__PURE__ */ (0, react_jsx_runtime.jsx)(IconMove, {}),
				appliesTo: "both",
				onSelect: (entry, h) => {
					h.promptMove(entry);
				}
			...
			registerFileAction({
				id: "delete",
				label: (t) => t("delete"),
				icon: /* @__PURE__ */ (0, react_jsx_runtime.jsx)(IconTrash, {}),
				danger: true,
				appliesTo: "both",
				onSelect: (entry, h) => {
					h.promptDelete(entry);
				}
			});
			registerFileAction({
				id: "new-file",
				label: (t) => t("newFile"),
				icon: /* @__PURE__ */ (0, react_jsx_runtime.jsx)(IconPlus, {}),
				appliesTo: "directory",
				onSelect: (entry, h) => {
					h.promptNewFile(entry.path);
				}
			});
			registerFileAction({
				id: "new-folder",
				label: (t) => t("newFolder"),
				icon: /* @__PURE__ */ (0, react_jsx_runtime.jsx)(IconFolderOpen, {}),
				appliesTo: "directory",
				onSelect: (entry, h) => {
					h.promptNewFolder(entry.path);
				}
			});
		}
		//#endregion
		...
		function FileExplorerDrawer({ open, onClose, title, onRefresh, onNew, t, children }) {
			...
			const newButtonRef = (0, react.useRef)(null);
				...
				children: [
					/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
						...
						children: [
							...
							onNew && /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("button", {
								ref: newButtonRef,
								className: "dsh-fe-new-button",
								"data-fe-new-button": true,
								onClick: () => {
									onNew(() => newButtonRef.current?.getBoundingClientRect() ?? null);
								},
								title: t("new"),
								children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)(IconPlus, { size: 14 }), /* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", { children: t("new") })]
							}),
		...
		function VirtualList({ rowCount, rowHeight, rowKey, overscan = 10, className, renderRow }) {
			...
			const heights = (0, react.useMemo)(() => typeof rowHeight === "number" ? Array.from({ length: rowCount }, () => rowHeight) : rowHeight, [rowCount, rowHeight]);
			const offsets = (0, react.useMemo)(() => {
			...
			const indexAt = (0, react.useCallback)((y) => {
				let lo = 0;
				let hi = rowCount;
				while (lo < hi) {
					const mid = lo + hi >> 1;
		...
		*/
		function FileContextMenu({ open, getAnchorRect, items, onClose }) {
			const menuRef = (0, react.useRef)(null);
			const [fixedPos, setFixedPos] = (0, react.useState)(null);
			const anchorRectRef = (0, react.useRef)(getAnchorRect);
			...
			if (!open) return null;
			const menu = /* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
				ref: menuRef,
				...
				children: items.map((item) => /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("button", {
					...
					children: [item.icon !== void 0 && /* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
						className: "dsh-fe-menu-item-icon",
						children: item.icon
					}), /* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
						className: "dsh-fe-menu-item-label",
						children: item.label
					})]
				}, item.id))
			});
			return (0, react_dom.createPortal)(menu, document.body);
		}
		//#endregion
		...
		//#endregion
		//#region src/client/tree-sort.ts
		/** Sort-option values backed by the tree toolbar `<select data-fe-sort>`. */
		const SORT_OPTIONS = [
			{
				value: "name-asc",
				localeKey: "sortNameAsc"
			},
			{
				value: "name-desc",
				localeKey: "sortNameDesc"
			},
			{
				value: "size-asc",
				localeKey: "sortSizeAsc"
			},
			{
				value: "size-desc",
				localeKey: "sortSizeDesc"
			},
			{
				value: "mtime-asc",
				localeKey: "sortMtimeAsc"
			},
			{
				value: "mtime-desc",
				localeKey: "sortMtimeDesc"
			}
		];
		/** Parse a `<select>` option value like "size-desc" into a SortSpec. */
		function parseSort(value) {
			const dash = value.lastIndexOf("-");
			const dir = value.slice(dash + 1) === "desc" ? "desc" : "asc";
		...
		function compareKey(a, b, key) {
			if (key === "size") {
				if (a.size !== void 0 && b.size !== void 0) return a.size - b.size;
				return 0;
			}
		...
		*/
		...
		function relativeTime(updatedAt, now) {
			...
			return {
				unit: "months",
				n: Math.min(11, Math.floor(days / 30))
			};
		}
		/** Format a timestamp as a localized relative-time label ("now"/"5min"/"3h"…). */
		function formatRelativeTime(t, updatedAt, now) {
		...
		const FileTree = (0, react.forwardRef)(function FileTree({ sessionId, helpers, fetchList, t, autoRefresh, selectedPath }, ref) {
			...
			const sortRef = (0, react.useRef)(sort);
				...
				setExpanded((prev) => {
					...
					if (next && !children[path]) {
						if (sessionId) fetchList(sessionId, path).then((list) => {
							...
							setChildren((prev) => ({
								...prev,
								[path]: sortEntries(list, sortRef.current)
							}));
						});
					}
					return {
			...
			const openMenu = (0, react.useCallback)((entry, getAnchorRect) => {
				setMenu({
					open: true,
					getAnchorRect,
					entry
			...
			const handleResultSelect = (0, react.useCallback)((entry) => {
			...
			const flat = (0, react.useMemo)(() => flattenVisible(entries, expanded, children), [
				entries,
				expanded,
				children
			]);
			const flatHeights = (0, react.useMemo)(() => flat.map((row) => row.entry.kind === "directory" ? DIR_ROW_HEIGHT : FILE_ROW_HEIGHT), [flat]);
			...
			return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
				...
				children: [
					/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
						className: "dsh-fe-search-bar",
						children: [
							/* @__PURE__ */ (0, react_jsx_runtime.jsx)(IconSearch, { size: 14 }),
							...
							/* @__PURE__ */ (0, react_jsx_runtime.jsx)("select", {
								...
								children: SORT_OPTIONS.map((opt) => /* @__PURE__ */ (0, react_jsx_runtime.jsx)("option", {
									value: opt.value,
									children: t(opt.localeKey)
								}, opt.value))
							})
						]
					}),
					searching ? results.length === 0 ? /* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
						className: "dsh-fe-tree-empty",
						"data-fe-search-empty": true,
						children: t("noSearchResults")
					}) : /* @__PURE__ */ (0, react_jsx_runtime.jsx)(VirtualList, {
						rowCount: results.length,
						rowHeight: SEARCH_ROW_HEIGHT,
						rowKey: (i) => results[i].path,
						renderRow: (i) => /* @__PURE__ */ (0, react_jsx_runtime.jsx)(SearchResultRow, {
		...
		function isAncestorDir(selectedPath, entry) {
			if (selectedPath === null || selectedPath === void 0 || entry.kind !== "directory") return false;
		...
		function TreeRow({ entry, depth, expanded, selected, active, t, onDisclosureClick, helpers, onOpenMenu }) {
			...
			const className = "dsh-fe-tree-row" + (isDir ? " dsh-fe-tree-row--dir" : " dsh-fe-tree-row--file") + (selected ? " dsh-fe-tree-row--selected" : "");
			const meta = isDir ? entry.mtimeMs !== void 0 ? formatRelativeTime(t, entry.mtimeMs, Date.now()) : "" : entry.size !== void 0 ? formatBytes(entry.size) : "";
			return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
				className,
				"data-fe-path": entry.path,
				"data-fe-kind": entry.kind,
				"data-fe-selected": selected ? "true" : void 0,
				...
				children: [
					...
					/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
						className: "dsh-fe-icon" + (active ? " dsh-fe-icon--active" : ""),
		...
		function SearchResultRow({ entry, onSelect }) {
			...
			return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
				...
				"data-fe-path": entry.path,
				"data-fe-kind": entry.kind,
				"data-fe-search-result": true,
				onClick: () => onSelect(entry),
				children: [/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
					className: "dsh-fe-search-result-heading",
					children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
						className: "dsh-fe-icon",
						children: isDir ? /* @__PURE__ */ (0, react_jsx_runtime.jsx)(IconFolderClose, { size: 16 }) : /* @__PURE__ */ (0, react_jsx_runtime.jsx)(IconFile, { size: 16 })
					}), /* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
						className: "dsh-fe-name",
						children: entry.name
					})]
				}), parent !== "" && /* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
					className: "dsh-fe-search-result-meta",
					children: parent
				})]
			});
		}
		/** 把面板位置钳制到视口内，保证 32px 标题栏始终完整可见。 */
		function clampToViewport(position, size, viewport) {
			const maxTop = Math.max(0, viewport.height - 32);
		...
		const FileExplorerPanel = (0, react.forwardRef)(function FileExplorerPanel({ title, t, children, onClose, initialVisible = false }, ref) {
			...
			const geometryRef = (0, react.useRef)(geometry);
			...
			(0, react.useEffect)(() => {
				...
				const reClamp = () => {
					...
					if (clamped.x !== position.x || clamped.y !== position.y) dispatch({
						type: "MOVE",
						payload: clamped
					});
				};
		...
		function joinRel(parentDir, name) {
			return parentDir === "" ? name : `${parentDir}/${name}`;
		}
		/** The final path segment of a workspace-relative path. */
		function basenameOfRel(path) {
			return path.split("/").at(-1) ?? path;
		}
		//#endregion
		//#region src/client/file-ops-modal.tsx
		...
		function flattenDirs(dirMap, expanded, rootDirs, path = "", depth = 0) {
			...
			for (const entry of rootDirs) {
				...
				if (expanded[entry.path] && dirMap[entry.path]) out.push(...flattenDirs(dirMap, expanded, dirMap[entry.path], entry.path, depth + 1));
			}
			return out;
		}
		function FileOpsModal({ op, fileOps, fetchList, sessionId, t, onDone, onCancel }) {
			const [value, setValue] = (0, react.useState)(() => initialValue(op));
			const [saving, setSaving] = (0, react.useState)(false);
			const [error, setError] = (0, react.useState)(null);
			const [destDir, setDestDir] = (0, react.useState)("");
			const [dirMap, setDirMap] = (0, react.useState)({});
			const [expanded, setExpanded] = (0, react.useState)({});
			const mountedRef = (0, react.useRef)(true);
			(0, react.useEffect)(() => () => {
				mountedRef.current = false;
			...
			(0, react.useEffect)(() => {
				...
				let cancelled = false;
				fetchList(sessionId, "").then((list) => {
					if (!cancelled) setDirMap({ "": list.filter((e) => e.kind === "directory") });
				}).catch(() => {});
				return () => {
					cancelled = true;
				};
			...
			const toggleDir = (path) => {
				...
				if (next && !dirMap[path]) {
					if (sessionId !== void 0) fetchList(sessionId, path).then((list) => {
						if (mountedRef.current) setDirMap((m) => ({
							...m,
							[path]: list.filter((e) => e.kind === "directory")
						}));
					}).catch(() => {});
				}
				setExpanded((prev) => ({
			...
			const submitLabel = kind === "rename" ? t("confirm") : kind === "delete" ? t("delete") : kind === "move" ? t("moveHere") : kind === "copy" ? t("copyHere") : t("create");
			const title = kind === "rename" ? t("rename") : kind === "delete" ? t("delete") : kind === "move" ? t("moveTo") : kind === "copy" ? t("copyTo") : kind === "new-file" ? t("newFile") : t("newFolder");
			const flatDirs = flattenDirs(dirMap, expanded, dirMap[""] ?? []);
			const submit = isInput ? finishInput : kind === "delete" ? confirmDelete : confirmDest;
			const disabled = isInput ? !canSubmit : saving;
			return /* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
				className: "dsh-fe-op-overlay",
				onClick: () => {
					if (!saving) onCancel();
				},
				children: /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
					className: "dsh-fe-op-modal",
					"data-fe-op": kind,
					onClick: (e) => e.stopPropagation(),
					children: [
						/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
							className: "dsh-fe-op-header",
							children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
								className: "dsh-fe-op-title",
								children: title
							}), /* @__PURE__ */ (0, react_jsx_runtime.jsx)("button", {
								type: "button",
								className: "dsh-fe-op-close",
								"data-fe-op-close": true,
								"aria-label": t("close"),
								title: t("close"),
								disabled: saving,
								onClick: onCancel,
						...
						/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
							className: "dsh-fe-op-body",
							children: [
								isInput && /* @__PURE__ */ (0, react_jsx_runtime.jsx)("input", {
									className: "dsh-fe-op-input",
									"data-fe-op-input": true,
									value,
									autoFocus: true,
								...
								kind === "delete" && /* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
									className: "dsh-fe-op-confirm",
									children: t("confirmDelete", { name: op.entry.name })
								}),
								isDest && /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
									className: "dsh-fe-op-dir",
									children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
										className: "dsh-fe-op-dir-hint",
										children: t("selectDestination")
									}), /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
										className: "dsh-fe-op-dir-list",
										children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)(DirRow, {
											selected: destDir === "",
											depth: 0,
											path: "",
											name: t("workspaceRoot"),
											onSelect: () => {
												if (!saving) setDestDir("");
											}
										}), flatDirs.map(({ entry, depth }) => /* @__PURE__ */ (0, react_jsx_runtime.jsx)(DirRow, {
											...
											onSelect: () => {
												if (!saving && !isExcluded(entry.path)) setDestDir(entry.path);
											},
						...
						/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
							className: "dsh-fe-op-actions",
							children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("button", {
								className: "dsh-fe-op-btn",
								"data-fe-op-cancel": true,
								disabled: saving,
								onClick: onCancel,
								children: t("cancel")
							}), /* @__PURE__ */ (0, react_jsx_runtime.jsx)("button", {
								className: "dsh-fe-op-btn " + (kind === "delete" ? "dsh-fe-op-btn--danger" : "dsh-fe-op-btn--primary"),
								"data-fe-op-submit": true,
								disabled,
								onClick: () => {
									submit();
								},
		...
		function DirRow({ selected, disabled, depth, path, name, expanded, onSelect, onToggle }) {
			return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
				...
				children: [
					onToggle !== void 0 ? /* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
						className: "dsh-fe-disclosure",
						onClick: (e) => {
							e.stopPropagation();
							if (disabled) return;
					...
					/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
						className: "dsh-fe-icon",
						children: /* @__PURE__ */ (0, react_jsx_runtime.jsx)(IconFolderClose, { size: 16 })
					}),
					/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
						className: "dsh-fe-name",
						children: name
		...
		*/
		function openInBrowserTab(sessionId, path) {
			...
			const url = `${STATIC_FILES_ROUTE}/${encodeURIComponent(sessionId)}/` + path.split("/").map(encodeURIComponent).join("/");
		...
		const FileExplorerApp = (0, react.forwardRef)(function FileExplorerApp({ sessionId, fetchList, fetchPreview, t, writeFile, readRawFile, fileOps }, ref) {
			...
			const [fileOp, setFileOp] = (0, react.useState)({ kind: "idle" });
			const [newMenu, setNewMenu] = (0, react.useState)({
				open: false,
				getAnchorRect: null
			});
			...
			const openFileAsText = (0, react.useCallback)((path) => {
				openFileWithMode(path, "text");
			}, [openFileWithMode]);
			const openFileAsBinary = (0, react.useCallback)((path) => {
				openFileWithMode(path, "binary");
			}, [openFileWithMode]);
			const copyAbsolutePath = (0, react.useCallback)(async (path) => {
				if (sessionId === void 0) return;
				try {
			...
			const copyRelativePath = (0, react.useCallback)(async (path) => {
				await navigator.clipboard.writeText(path);
			}, []);
			const handleOpDone = (0, react.useCallback)((newPath) => {
				const op = fileOp;
				setFileOp({ kind: "idle" });
				...
				if (op.kind === "rename" || op.kind === "move") {
					if (selectedPathRef.current === op.entry.path) {
						...
						if (sessionId !== void 0) fetchPreview(sessionId, newPath).then((preview) => {
							if (selectedPathRef.current === newPath) setPreviewData(preview);
						}).catch(() => {});
					}
			...
			const handleOpCancel = (0, react.useCallback)(() => {
				setFileOp({ kind: "idle" });
			}, []);
			const openNewMenu = (0, react.useCallback)((getAnchorRect) => {
				setNewMenu({
					open: true,
					getAnchorRect
				});
			...
			const helpers = {
				...
				copyAbsolutePath,
				copyRelativePath,
				promptRename: (0, react.useCallback)((entry) => {
					setFileOp({
						kind: "rename",
						entry
					});
				}, []),
				promptDelete: (0, react.useCallback)((entry) => {
					setFileOp({
						kind: "delete",
						entry
					});
				}, []),
				promptMove: (0, react.useCallback)((entry) => {
					setFileOp({
						kind: "move",
						entry
					});
				}, []),
				promptCopy: (0, react.useCallback)((entry) => {
					setFileOp({
						kind: "copy",
						entry
					});
				}, []),
				promptNewFile: (0, react.useCallback)((parentDir) => {
					setFileOp({
						kind: "new-file",
						parentDir
					});
				}, []),
				promptNewFolder: (0, react.useCallback)((parentDir) => {
					setFileOp({
						kind: "new-folder",
						parentDir
					});
			...
			if (previewData !== null) resolvedComponent = viewMode === "text" ? makeTextPagedPreview(readRawFile) : viewMode === "binary" ? BinaryPreview : resolvePreviewFor(previewData, extensionOf(selectedPath ?? ""), readRawFile);
			const isMarkdown = resolvedComponent === MarkdownPreview;
			const isEditableText = writeFile !== void 0 && viewMode === "auto" && previewData !== null && previewData.kind === "text" && (resolvedComponent === TextPreview || resolvedComponent === makeTextPagedPreview(readRawFile) || isMarkdown);
			let previewChildren;
			if (previewData === null) previewChildren = /* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
				...
				if (isEditableText) previewChildren = /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
					className: "dsh-fe-md",
					children: [
						/* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
						...
						}) : /* @__PURE__ */ (0, react_jsx_runtime.jsx)(PreviewComponent, {
							preview: previewData,
				...
				else previewChildren = /* @__PURE__ */ (0, react_jsx_runtime.jsx)(PreviewComponent, {
					preview: previewData,
					filePath: selectedPath ?? "",
					activeView: "preview",
					t
			...
			return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)(react_jsx_runtime.Fragment, { children: [
				...
				/* @__PURE__ */ (0, react_jsx_runtime.jsx)(FileContextMenu, {
					...
					onClose: () => setNewMenu((prev) => ({
						...prev,
						open: false
					}))
				}),
				fileOp.kind !== "idle" && fileOps !== void 0 && /* @__PURE__ */ (0, react_jsx_runtime.jsx)(FileOpsModal, {
					op: fileOp,
					fileOps,
					fetchList,
					sessionId,
...
.dsh-fe-panel {
  ...
  position: fixed;
  z-index: 10000;
  box-shadow: var(--dsw-shadow-lv3, 0 0 1px 0 rgba(0, 0, 0, 0.2), 0 0 4px 0 rgba(0, 0, 0, 0.02), 0 12px 32px 0 rgba(0, 0, 0, 0.08));
...
.dsh-fe-tree-row--selected { background: var(--dsw-alias-interactive-bg-hover, #0000000d); }
.dsh-fe-disclosure {
  width: 16px;
  height: 16px;
  flex-shrink: 0;
...
.dsh-fe-icon--active { color: var(--dsw-alias-state-business-primary, #4a90d9); }
.dsh-fe-name {
  flex: 1;
  min-width: 0;
  overflow: hidden;
...
.dsh-fe-tree-row:hover .dsh-fe-row-actions { display: inline-flex; }
...
.dsh-fe-tree-row:hover .dsh-fe-row-meta { display: none; }
.dsh-fe-menu {
  position: fixed;
  z-index: 1100;
  min-width: 218px;
  ...
  box-sizing: border-box;
  padding: 4px;
  border: 1px solid var(--dsw-alias-border-inverted, var(--dsw-alias-border-l2, rgba(0, 0, 0, 0.1)));
  border-radius: 12px;
...
.dsh-fe-menu-item:hover { background: var(--dsw-alias-interactive-bg-hover, rgba(0, 0, 0, 0.06)); }
.dsh-fe-menu-item-icon {
  display: inline-flex;
  flex: none;
  width: 16px;
  height: 16px;
...
.dsh-fe-menu-item--danger { color: var(--dsw-alias-state-error-primary, #ec1313); }
.dsh-fe-menu-item--danger .dsh-fe-menu-item-icon { color: var(--dsw-alias-state-error-primary, #ec1313); }
.dsh-fe-menu-item--danger:hover { background: var(--dsw-alias-interactive-bg-hover-danger, rgba(236, 19, 19, 0.05)); }
...
.dsh-fe-drawer { position: fixed; left: 0; top: 0; bottom: 0; width: 280px; z-index: 999; display: flex; flex-direction: column; background: var(--dsw-alias-bg-base, #fff); border-right: 1px solid var(--dsw-alias-border-l2, rgba(0,0,0,0.1)); box-shadow: var(--dsw-shadow-lv2, 0 4px 12px 0 rgba(0,0,0,0.02), 0 2px 8px 0 rgba(0,0,0,0.04)); }
...
.dsh-fe-md-error { padding: 8px 12px; color: var(--dsw-alias-state-error-primary, #ec1313); font-size: 13px; }
.dsh-fe-op-overlay { position: fixed; inset: 0; z-index: 10050; padding: 24px; display: flex; align-items: center; justify-content: center; background: var(--dsw-alias-bg-mask-1, rgba(0,0,0,0.32)); -webkit-backdrop-filter: var(--dsw-mask-blur, blur(2px)); backdrop-filter: var(--dsw-mask-blur, blur(2px)); }
.dsh-fe-op-modal { display: flex; flex-direction: column; gap: 20px; width: min(380px, 100%); max-height: 80vh; padding: 0 0 24px; overflow: hidden; border: 1px solid var(--dsw-alias-border-inverted, rgba(0,0,0,0.1)); border-radius: 24px; background: var(--dsw-alias-bg-layer-2, #fff); box-shadow: var(--dsw-shadow-lv3, 0 0 1px 0 rgba(0,0,0,0.2), 0 0 4px 0 rgba(0,0,0,0.02), 0 12px 32px 0 rgba(0,0,0,0.08)); }
.dsh-fe-op-header { display: flex; align-items: center; justify-content: space-between; gap: 8px; padding: 22px 14px 12px 24px; flex-shrink: 0; }
.dsh-fe-op-title { margin: 0; font-size: 16px; line-height: 24px; font-weight: 500; color: var(--dsw-alias-label-primary, #333); }
.dsh-fe-op-close { flex: none; display: inline-flex; align-items: center; justify-content: center; width: 28px; height: 28px; border: none; border-radius: 8px; background: transparent; cursor: pointer; padding: 0; color: var(--dsw-alias-label-secondary, #999); }
.dsh-fe-op-close:hover { background: var(--dsw-alias-interactive-bg-hover, #0000000d); }
.dsh-fe-op-close:disabled { cursor: default; opacity: 0.4; }
.dsh-fe-op-body { display: flex; flex-direction: column; gap: 8px; padding: 0 24px; min-height: 0; overflow: auto; }
.dsh-fe-op-input { width: 100%; box-sizing: border-box; font: 13px/1.6 ui-monospace, SFMono-Regular, Consolas, monospace; padding: 6px 8px; border: 1px solid var(--dsw-alias-border-inverted, rgba(0,0,0,0.1)); border-radius: 4px; background: var(--dsw-alias-bg-base, #fff); color: var(--dsw-alias-label-primary, #333); }
.dsh-fe-op-confirm { font-size: 14px; line-height: 22px; color: var(--dsw-alias-label-primary, #333); }
.dsh-fe-op-dir-hint { font-size: 12px; color: var(--dsw-alias-label-secondary, #999); }
.dsh-fe-op-dir-list { max-height: 240px; overflow: auto; border: 1px solid var(--dsw-alias-border-inverted, rgba(0,0,0,0.1)); border-radius: 4px; padding: 4px 0; }
.dsh-fe-op-dir-row { display: flex; align-items: center; gap: 6px; height: 28px; padding: 0 8px; cursor: pointer; color: var(--dsw-alias-label-primary, #333); }
.dsh-fe-op-dir-row:hover { background: var(--dsw-alias-interactive-bg-hover, #0000000d); }
.dsh-fe-op-dir-row[data-selected='true'] { background: var(--dsw-alias-state-business-primary, rgba(74,144,217,0.15)); }
.dsh-fe-op-dir-row[data-disabled='true'] { opacity: 0.4; cursor: not-allowed; }
.dsh-fe-op-error { padding: 0 24px; color: var(--dsw-alias-state-error-primary, #ec1313); font-size: 13px; flex-shrink: 0; }
.dsh-fe-op-actions { display: flex; align-items: center; justify-content: flex-end; gap: 8px; padding: 0 24px; flex-shrink: 0; }
.dsh-fe-op-btn { display: inline-flex; align-items: center; justify-content: center; gap: 4px; border: none; border-radius: 18px; height: 36px; padding: 0 14px; cursor: pointer; font-size: 14px; line-height: 22px; color: var(--dsw-alias-label-primary, #333); background: transparent; }
.dsh-fe-op-btn:hover:not(:disabled) { background: var(--dsw-alias-interactive-bg-hover, #0000000d); }
.dsh-fe-op-btn:disabled { opacity: 0.4; cursor: not-allowed; }
.dsh-fe-op-btn--primary { background: var(--dsw-alias-button-primary-fill, #4a90d9); color: var(--dsw-alias-label-primary-foreground, #fff); }
.dsh-fe-op-btn--primary:hover:not(:disabled) { background: var(--dsw-alias-button-primary-hover, #3b7fc4); }
.dsh-fe-op-btn--danger { color: var(--dsw-alias-state-error-primary, #ec1313); }
.dsh-fe-op-btn--danger:hover:not(:disabled) { background: var(--dsw-alias-interactive-bg-hover-danger, rgba(236,19,19,0.1)); }
.dsh-fe-md-content {
  padding: 20px 24px;
  line-height: 1.7;
  max-width: 44em;
...
.dsh-fe-preview-error { padding: 0 8px 8px; color: var(--dsw-alias-state-error-primary, #ec1313); font-size: 13px; }
...
.dsh-fe-csv { display: flex; flex-direction: column; height: 100%; min-height: 0; }
.dsh-fe-csv-scroll { flex: 1; min-height: 0; overflow: auto; }
.dsh-fe-table { border-collapse: collapse; width: 100%; font-size: 12px; }
.dsh-fe-table th, .dsh-fe-table td { border: 1px solid var(--dsw-alias-border-l2, #e0e0e0); padding: 4px 8px; text-align: left; white-space: nowrap; }
.dsh-fe-table th { position: sticky; top: 0; background: var(--dsw-alias-bg-base, #fff); color: var(--dsw-alias-label-secondary, #999); font-weight: 600; }
.dsh-fe-csv-truncated { padding: 6px 8px; font-size: 12px; color: var(--dsw-alias-label-secondary, #999); }
.dsh-fe-preview-empty { padding: 12px; color: var(--dsw-alias-label-secondary, #999); font-size: 13px; }
...
.dsh-fe-sort option { color: var(--dsw-alias-label-primary, #333); background: var(--dsw-alias-bg-base, #fff); }
.dsh-fe-search-result {
  display: flex;
  flex-direction: column;
  align-items: stretch;
  justify-content: center;
...
.dsh-fe-search-result-heading { display: flex; align-items: center; gap: 6px; min-width: 0; }
.dsh-fe-search-result-meta {
  padding-left: 22px;
  overflow: hidden;
  text-overflow: ellipsis;
  white-space: nowrap;
...
`;
		...
		function apply(ctx) {
			...
			const mutate = async (action, body) => {
				...
				const data = await (await fetch(`${FILE_EXPLORER_ROUTE}?action=${encodeURIComponent(action)}&sessionId=${encodeURIComponent(sessionId)}`, {
					method: "POST",
			...
			const fileOps = {
				...
				rename: (path, name) => mutate(RENAME_ACTION, {
					path,
					name
				}),
				remove: (path) => mutate(DELETE_ACTION, { path }),
				move: (path, toDir) => mutate(MOVE_ACTION, {
					path,
					toDir
				}),
				copy: (path, toDir) => mutate(COPY_ACTION, {
					path,
					toDir
				})
			};
