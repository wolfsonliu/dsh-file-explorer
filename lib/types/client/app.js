...
import { BinaryPreview, MarkdownPreview, makeTextPagedPreview, resolvePreviewFor } from "./preview/index.js";
...
export const FileExplorerApp = forwardRef(function FileExplorerApp({ sessionId, fetchList, fetchPreview, t, writeFile, readRawFile, fileOps }, ref) {
    ...
    const [newMenu, setNewMenu] = useState({ open: false, anchor: { x: 0, y: 0 } });
    ...
    const openNewMenu = useCallback((anchor) => {
    ...
    return (_jsxs(_Fragment, { children: [_jsx(FloatingFileButton, { onClick: toggleDrawer, t: t, open: drawerOpen }), _jsx(FileExplorerDrawer, { open: drawerOpen, onClose: closeDrawer, onRefresh: () => treeRef.current?.refresh(), onNew: openNewMenu, t: t, children: _jsx(FileTree, { ref: treeRef, sessionId: sessionId, fetchList: fetchList, helpers: helpers, t: t, autoRefresh: drawerOpen }) }), _jsx(FileContextMenu, { open: newMenu.open, anchor: newMenu.anchor, items: [
