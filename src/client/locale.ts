...
export const ZH = {
  ...
  open: '打开', copyPath: '复制路径', copyAbsolutePath: '复制绝对路径', copyRelativePath: '复制相对路径',
...
export const EN = {
  ...
  open: 'Open', copyPath: 'Copy path', copyAbsolutePath: 'Copy absolute path', copyRelativePath: 'Copy relative path',
