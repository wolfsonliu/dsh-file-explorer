...
import { COPY_ACTION, CREATE_FILE_ACTION, DELETE_ACTION, FILE_EXPLORER_ROUTE, MKDIR_ACTION, MOVE_ACTION, RENAME_ACTION, } from "../protocol.js";
...
export function apply(ctx) {
    ...
    const mutate = async (action, body) => {
        ...
        const res = await fetch(`${FILE_EXPLORER_ROUTE}?action=${encodeURIComponent(action)}&sessionId=${encodeURIComponent(sessionId)}`, {
            method: 'POST',
