...
// Component
// ---------------------------------------------------------------------------
export const FileExplorerPanel = forwardRef(function FileExplorerPanel({ title, children, initialVisible = false }, ref) {
    ...
    return (_jsxs("div", { className: "dsh-fe-panel", "data-visible": geometry.visible, "data-minimized": geometry.minimized, "data-maximized": geometry.maximized, style: panelStyle, children: [_jsxs("div", { className: "dsh-fe-title-bar", "data-fe-title-bar": true, onPointerDown: isMaximized ? undefined : titleDrag.onPointerDown, children: [_jsx("span", { className: "dsh-fe-title-text", children: title ?? '文件浏览器' }), _jsxs("div", { className: "dsh-fe-title-actions", children: [_jsx("button", { className: "dsh-fe-btn", "data-fe-action": "minimize", onClick: () => dispatch({ type: 'MINIMIZE' }), title: geometry.minimized ? '展开' : '最小化', children: geometry.minimized ? '□' : '−' }), _jsx("button", { className: "dsh-fe-btn", "data-fe-action": "maximize", onClick: () => dispatch({ type: 'MAXIMIZE' }), title: isMaximized ? '还原' : '最大化', children: isMaximized ? '❐' : '□' }), _jsx("button", { className: "dsh-fe-btn", "data-fe-action": "close", onClick: () => dispatch({ type: 'CLOSE' }), title: "\u5173\u95ED", children: "\u2715" })] })] }), !geometry.minimized && (_jsx("div", { className: "dsh-fe-body", "data-fe-body": true, children: children }))] }));
});
