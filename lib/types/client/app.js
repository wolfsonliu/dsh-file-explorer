...
export const FileExplorerApp = forwardRef(function FileExplorerApp({ sessionId, fetchList, fetchPreview, t, writeFile, readRawFile, fileOps }, ref) {
    ...
    return (_jsxs(_Fragment, { children: [_jsx(FloatingFileButton, { onClick: toggleDrawer, t: t, open: drawerOpen }), _jsx(FileExplorerDrawer, { open: drawerOpen, onClose: closeDrawer, onRefresh: () => treeRef.current?.refresh(), onNew: openNewMenu, t: t, children: _jsx(FileTree, { ref: treeRef, sessionId: sessionId, fetchList: fetchList, helpers: helpers, t: t, autoRefresh: drawerOpen, selectedPath: selectedPath }) }), _jsx(FileContextMenu, { open: newMenu.open, getAnchorRect: newMenu.getAnchorRect ?? (() => null), items: [
