window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		const StatusPreview = ({ preview, filePath }) => {
			...
			if (preview.kind === "empty") return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", { children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("p", { children: /* @__PURE__ */ (0, react_jsx_runtime.jsx)("strong", { children: preview.name }) }), /* @__PURE__ */ (0, react_jsx_runtime.jsx)("p", { children: "空文件" })] });
			if (preview.kind === "binary") return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", { children: [
				/* @__PURE__ */ (0, react_jsx_runtime.jsx)("p", { children: /* @__PURE__ */ (0, react_jsx_runtime.jsx)("strong", { children: preview.name }) }),
				/* @__PURE__ */ (0, react_jsx_runtime.jsx)("p", { children: "无法预览此文件（二进制）" }),
				/* @__PURE__ */ (0, react_jsx_runtime.jsx)("p", { children: sizeStr })
			] });
			if (preview.kind === "too-large") return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", { children: [
				/* @__PURE__ */ (0, react_jsx_runtime.jsx)("p", { children: /* @__PURE__ */ (0, react_jsx_runtime.jsx)("strong", { children: preview.name }) }),
				/* @__PURE__ */ (0, react_jsx_runtime.jsx)("p", { children: "文件过大，无法预览" }),
				/* @__PURE__ */ (0, react_jsx_runtime.jsx)("p", { children: sizeStr })
			] });
			return null;
		};
		...
		const TextPreview = (props) => {
			if (props.preview.kind === "text") return /* @__PURE__ */ (0, react_jsx_runtime.jsx)("pre", { children: /* @__PURE__ */ (0, react_jsx_runtime.jsx)("code", { children: props.preview.content }) });
...
Please report this to https://github.com/markedjs/marked.`, e) {
		...
		const MarkdownPreview = (props) => {
			if (props.preview.kind === "text") {
				if (props.activeView === "source") return /* @__PURE__ */ (0, react_jsx_runtime.jsx)("pre", { children: /* @__PURE__ */ (0, react_jsx_runtime.jsx)("code", { children: props.preview.content }) });
				const html = purify.sanitize(f.parse(props.preview.content));
				return /* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", { dangerouslySetInnerHTML: { __html: html } });
			}
			return /* @__PURE__ */ (0, react_jsx_runtime.jsx)(StatusPreview, { ...props });
		};
		//#endregion
		...
		const FileExplorerPanel = (0, react.forwardRef)(function FileExplorerPanel({ title, children, initialVisible = false }, ref) {
			...
			return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
				...
				}), !geometry.minimized && /* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
		...
		*/
		...
		//#endregion
		//#region src/client/mount-sidebar.ts
		/**
		...
		*/
		...
		function FileTree({ sessionId, fetchList, onSelectFile, onContextMenu }) {
			...
			return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
				...
				children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
					...
					children: /* @__PURE__ */ (0, react_jsx_runtime.jsx)(EntryList, {
						entries,
						depth: 0,
						expanded,
		...
		function EntryList({ entries, depth, expanded, childrenMap, onDisclosureClick, onSelectFile, onContextMenu }) {
			return /* @__PURE__ */ (0, react_jsx_runtime.jsx)(react_jsx_runtime.Fragment, { children: entries.map((entry) => /* @__PURE__ */ (0, react_jsx_runtime.jsxs)(react.default.Fragment, { children: [/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
				...
				children: [
					entry.kind === "directory" ? /* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
			...
			}), entry.kind === "directory" && expanded[entry.path] && childrenMap[entry.path] && /* @__PURE__ */ (0, react_jsx_runtime.jsx)(EntryList, {
		...
		//#endregion
		//#region src/client/sidebar-explorer.tsx
		/** Sidebar tab bar (「会话 / 文件」) plus the overlay file tree. */
		const SidebarExplorer = (0, react.forwardRef)(function SidebarExplorer({ sessionId, fetchList, onSelectFile }, ref) {
			...
			}), active === "files" && /* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
				className: "dsh-fe-sidebar-tree",
				"data-fe-tree-visible": "true",
...
.dsh-fe-panel {
  ...
  --fe-title-bg: var(--dsw-alias-bg-header, #f5f5f5);
  --fe-title-fg: var(--dsw-alias-fg-base, #333);
  --fe-divider: var(--dsw-alias-border-l2, #0000001a);
  --fe-btn-hover: var(--dsw-alias-bg-hover, #0000000d);
...
.dsh-fe-divider:hover, .dsh-fe-divider:active { background: var(--dsw-alias-accent, #4a90d9); }
...
.dsh-fe-disclosure { width: 12px; flex-shrink: 0; color: #999; }
.dsh-fe-file-icon { flex-shrink: 0; color: #999; }
...
`;
		...
		function apply(ctx) {
			...
			const previewRoot = (0, react_dom_client.createRoot)(previewHost);
			const previewPanelRef = react.default.createRef();
			...
			function renderPreview() {
				...
				if (previewState) {
					...
					children = react.default.createElement(PreviewComponent, previewProps);
				} else children = react.default.createElement("div", { className: "dsh-fe-placeholder" }, "从文件树选择文件");
				previewRoot.render(react.default.createElement(FileExplorerPanel, {
					ref: previewPanelRef,
					children
				}));
			}
			renderPreview();
			const sidebarRef = react.default.createRef();
			let sidebarRoot = null;
			let sidebarTab = "sessions";
			const fetchList = async (sessionId, path) => {
				try {
					return (await (await fetch(`/file-explorer/api?action=list&sessionId=${encodeURIComponent(sessionId)}&path=${encodeURIComponent(path)}`)).json()).entries ?? [];
				} catch {
					return [];
				}
			};
			...
			function renderSidebar() {
				...
				const sessionId = ctx.sessions.list.getSnapshot().current;
				sidebarRoot.render(react.default.createElement(SidebarExplorer, {
					ref: sidebarRef,
					sessionId,
					fetchList,
			...
			const disposeSidebar = mountSidebar((sidebarHost) => {
				sidebarRoot = (0, react_dom_client.createRoot)(sidebarHost);
				renderSidebar();
			});
