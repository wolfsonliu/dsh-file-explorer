		...
		*/
		...
		const StatusPreview = ({ preview, t }) => {
			...
			if (preview.kind === "binary") return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", { children: [
				...
				/* @__PURE__ */ (0, react_jsx_runtime.jsx)("p", { children: t("binary") }),
...
Please report this to https://github.com/markedjs/marked.`, e) {
		...
		* like LICENSE).
		*/
		function resolvePreviewFor(preview, ext) {
		...
		function FloatingFileButton({ onClick, t }) {
		...
		const FileTree = (0, react.forwardRef)(function FileTree({ sessionId, helpers, fetchList, t }, ref) {
			...
			return /* @__PURE__ */ (0, react_jsx_runtime.jsx)(react_jsx_runtime.Fragment, { children: entries.map((entry) => /* @__PURE__ */ (0, react_jsx_runtime.jsxs)(react.default.Fragment, { children: [/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
				...
				children: [
					...
					/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
						...
						children: entry.kind === "directory" ? expanded[entry.path] ? /* @__PURE__ */ (0, react_jsx_runtime.jsx)(IconFolderOpen, { size: 16 }) : /* @__PURE__ */ (0, react_jsx_runtime.jsx)(IconFolderClose, { size: 16 }) : /* @__PURE__ */ (0, react_jsx_runtime.jsx)(IconFile, { size: 16 })
					}),
					/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
		...
		const FileExplorerPanel = (0, react.forwardRef)(function FileExplorerPanel({ title, t, children, initialVisible = false }, ref) {
		...
		const FileExplorerApp = (0, react.forwardRef)(function FileExplorerApp({ sessionId, fetchList, fetchPreview, t }, ref) {
			...
			const openFileWithMode = (0, react.useCallback)((path, mode) => {
			...
			const openFile = (0, react.useCallback)((path) => openFileWithMode(path, "auto"), [openFileWithMode]);
			const helpers = {
				openFile,
				openFileAsText: (0, react.useCallback)((path) => openFileWithMode(path, "text"), [openFileWithMode]),
				openFileAsBinary: (0, react.useCallback)((path) => openFileWithMode(path, "binary"), [openFileWithMode]),
			...
			if (previewData === null) previewChildren = /* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
				...
				const PreviewComponent = viewMode === "text" ? TextPreview : viewMode === "binary" ? BinaryPreview : resolvePreviewFor(previewData, extensionOf(selectedPath ?? ""));
