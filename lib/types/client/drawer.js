...
import { IconClose, IconFolderOpen, IconRefresh } from "./icons.js";
...
export function FloatingFileButton({ onClick, t }) {
    ...
    return (_jsxs("button", { className: "dsh-fe-file-button", "data-fe-file-button": true, onClick: handleClick, title: t('title'), style: { top }, onPointerDown: onPointerDown, onPointerMove: onPointerMove, onPointerUp: onPointerUp, onPointerCancel: onPointerCancel, children: [_jsx(IconFolderOpen, { size: 18 }), _jsx("span", { className: "dsh-fe-file-button-label", children: t('file') })] }));
}
