...
import { IconBrowse, IconCode, IconCopy, IconDownload, IconEdit, IconFolderOpen, IconListPen, IconPlus, IconTrash } from "./icons.js";
const actions = [];
...
export function registerBuiltinFileActions() {
    ...
    registerFileAction({ id: 'move', label: t => t('moveTo'), icon: _jsx(IconDownload, {}), appliesTo: 'both', onSelect: (entry, h) => { h.promptMove(entry); } });
