...
export function FloatingFileButton({ onClick }) {
    ...
    return (_jsxs("button", { className: "dsh-fe-file-button", "data-fe-file-button": true, onClick: handleClick, title: "\u6587\u4EF6\u6D4F\u89C8\u5668\uFF08\u53EF\u4E0A\u4E0B\u62D6\u52A8\uFF09", style: { top }, onPointerDown: onPointerDown, onPointerMove: onPointerMove, onPointerUp: onPointerUp, onPointerCancel: onPointerCancel, children: [_jsx(IconPanelLeft, { size: 16 }), _jsx("span", { className: "dsh-fe-file-button-label", children: "\u6587\u4EF6" })] }));
}
