...
Please report this to https://github.com/markedjs/marked.`, e) {
		...
		*/
		...
		const FileExplorerApp = (0, react.forwardRef)(function FileExplorerApp({ sessionId, fetchList, fetchPreview, t, writeFile }, ref) {
			...
			const saveDraft = (0, react.useCallback)(async () => {
				if (writeFile === void 0 || selectedPath === null) return;
				...
				try {
					...
					if (selectedPathRef.current === targetPath) setPreviewData((prev) => prev && prev.kind === "text" ? {
						...prev,
						content: draft
					} : prev);
				} catch (error) {
