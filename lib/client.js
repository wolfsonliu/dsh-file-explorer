...
Please report this to https://github.com/markedjs/marked.`, e) {
		...
		*/
		...
		const FileExplorerApp = (0, react.forwardRef)(function FileExplorerApp({ sessionId, fetchList, fetchPreview, t, writeFile, readRawFile, fileOps }, ref) {
			...
			const openNewMenu = (0, react.useCallback)((anchor) => {
				setNewMenu({
					open: true,
					anchor
				});
...
.dsh-fe-op-modal { background: var(--fe-bg); border: 1px solid var(--fe-border); border-radius: 8px; box-shadow: 0 12px 32px rgba(0,0,0,0.2); width: 380px; max-width: 90vw; max-height: 80vh; display: flex; flex-direction: column; overflow: hidden; }
...
.dsh-fe-op-btn--danger { background: var(--dsw-alias-state-danger, #c0392b); border-color: var(--dsw-alias-state-danger, #c0392b); color: #fff; }
.dsh-fe-op-btn--danger:hover { background: var(--dsw-alias-state-danger, #c0392b); }
.dsh-fe-md-content {
  padding: 20px 24px;
  line-height: 1.7;
  max-width: 44em;
...
.dsh-fe-table th, .dsh-fe-table td { border: 1px solid var(--dsw-alias-divider, #e0e0e0); padding: 4px 8px; text-align: left; white-space: nowrap; }
.dsh-fe-table th { position: sticky; top: 0; background: var(--dsw-alias-surface, #fff); color: var(--dsw-alias-label-secondary, #999); font-weight: 600; }
