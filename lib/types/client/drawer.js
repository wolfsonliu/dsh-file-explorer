...
export function FileExplorerDrawer({ open, onClose, title, onRefresh, onNew, t, children, }) {
    ...
    return (_jsxs("div", { className: "dsh-fe-drawer", "data-fe-drawer": true, style: { width }, children: [_jsxs("div", { className: "dsh-fe-drawer-title", children: [_jsx("span", { className: "dsh-fe-drawer-title-text", children: title ?? t('title') }), onNew && (_jsxs("button", { className: "dsh-fe-new-button", "data-fe-new-button": true, onClick: (e) => {
