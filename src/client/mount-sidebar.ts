...
export function findSidebarTree(root: ParentNode): HTMLElement | null {
  return root.querySelector<HTMLElement>('[role="tree"]')
}
 ...
 */
export function mountSidebar(onReady: (host: HTMLElement) => void): () => void {
