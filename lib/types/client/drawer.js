...
export function FloatingFileButton({ onClick }) {
    return (_jsxs("button", { className: "dsh-fe-file-button", "data-fe-file-button": true, onClick: onClick, title: "\u6587\u4EF6\u6D4F\u89C8\u5668", children: [_jsx(IconPanelLeft, { size: 16 }), _jsx("span", { className: "dsh-fe-file-button-label", children: "\u6587\u4EF6" })] }));
}
