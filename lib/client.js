...
Please report this to https://github.com/markedjs/marked.`, e) {
		...
		function FileExplorerDrawer({ open, onClose, title, children }) {
			if (!open) return null;
		...
		function FloatingFileButton({ onClick }) {
			return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("button", {
				className: "dsh-fe-file-button",
				"data-fe-file-button": true,
				onClick,
				title: "文件浏览器",
				children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)(IconPanelLeft, { size: 16 }), /* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
		...
		const FileExplorerApp = (0, react.forwardRef)(function FileExplorerApp({ sessionId, fetchList, fetchPreview }, ref) {
			...
			const openFile = (0, react.useCallback)((path) => {
				...
				fetchPreview(sessionId, path).then((preview) => {
			...
			return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)(react_jsx_runtime.Fragment, { children: [
				/* @__PURE__ */ (0, react_jsx_runtime.jsx)(FloatingFileButton, { onClick: toggleDrawer }),
...
.dsh-fe-file-button { position: fixed; left: 0; top: 50%; transform: translateY(-50%); z-index: 1000; display: inline-flex; align-items: center; gap: 6px; height: 36px; width: 30px; padding: 0 7px; border: 1px solid var(--dsw-alias-border-l2, rgba(0,0,0,0.1)); border-left: none; border-radius: 0 18px 18px 0; background: var(--dsw-alias-bg-base, #fff); box-shadow: 2px 0 8px rgba(0,0,0,0.12); cursor: pointer; font-size: 13px; color: var(--dsw-alias-label-primary, #333); overflow: hidden; white-space: nowrap; transition: width 0.15s ease; }
			...
			function render() {
				...
				root.render(react.default.createElement(FileExplorerApp, {
					...
					fetchPreview: async (sid, path) => {
						try {
							return (await (await fetch(`/file-explorer/api?action=preview&sessionId=${encodeURIComponent(sid)}&path=${encodeURIComponent(path)}`)).json()).preview ?? null;
						} catch {
							return null;
						}
					}
