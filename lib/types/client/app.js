...
export const FileExplorerApp = forwardRef(function FileExplorerApp({ sessionId, fetchList, fetchPreview, t, writeFile, readRawFile }, ref) {
    ...
    return (_jsxs(_Fragment, { children: [_jsx(FloatingFileButton, { onClick: toggleDrawer, t: t, open: drawerOpen }), _jsx(FileExplorerDrawer, { open: drawerOpen, onClose: closeDrawer, onRefresh: () => treeRef.current?.refresh(), t: t, children: _jsx(FileTree, { ref: treeRef, sessionId: sessionId, fetchList: fetchList, helpers: helpers, t: t, autoRefresh: drawerOpen }) }), _jsx(FileExplorerPanel, { ref: previewPanelRef, title: panelTitle, onClose: handlePanelClose, t: t, children: previewChildren })] }));
});
