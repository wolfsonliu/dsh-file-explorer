...
export const FileExplorerApp = forwardRef(function FileExplorerApp({ sessionId, fetchList, fetchPreview, t }, ref) {
    ...
    const helpers = { openFile, copyAbsolutePath, copyRelativePath };
    ...
    return (_jsxs(_Fragment, { children: [_jsx(FloatingFileButton, { onClick: toggleDrawer, t: t }), _jsx(FileExplorerDrawer, { open: drawerOpen, onClose: closeDrawer, onRefresh: () => treeRef.current?.refresh(), t: t, children: _jsx(FileTree, { ref: treeRef, sessionId: sessionId, fetchList: fetchList, helpers: helpers, t: t }) }), _jsx(FileExplorerPanel, { ref: previewPanelRef, t: t, children: previewChildren })] }));
});
